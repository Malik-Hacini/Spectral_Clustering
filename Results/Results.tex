...
We used the same 11 benchmark datasets from the UCI repository \cite{UCI} as (\cite[Jonckheere et.al]{GSC}). These datasets are high dimensional and to correctly assert performance of the clustering, we need a pertinent metric.
